...
public class ElementUtil {
	...
	//Don't use wait in this method because it behaves as global wait when this method is called
	...
	@Step("Entering value {1} in text feild using locator: {0} and waiting for element with: {2} sec")
	...
	@Step("Entering value {1} in text feild using locator: {0}")
